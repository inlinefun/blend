...
abstract class AbstractModule(
    ...
    fun int(name: String, defaultValue: Int, minimum: Int, maximum: Int, parent: ValueParent = this, visibility: () -> Boolean = { true }) = IntValue(name, parent, visibility, defaultValue, minimum, maximum)
